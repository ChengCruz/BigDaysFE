...
export default function CheckInPageV2() {
  ...
  useEffect(() => {
    ...
    import("html5-qrcode").then(({ Html5Qrcode }) => {
      ...
      try {
        instance = new Html5Qrcode("qr-reader-v2");
      } catch {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
        ...
        <CameraErrorBoundary onReset={handleStopCamera}>
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5 flex flex-col gap-4">
            ...
            {cameraActive && (
              <div id="qr-reader-v2" className="rounded-xl overflow-hidden border border-gray-200 dark:border-white/10" />
            )}
