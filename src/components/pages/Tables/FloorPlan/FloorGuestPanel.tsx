...
export const FloorGuestPanel: React.FC<Props> = ({ guests, tables, onGuestDragStart, onGuestDragEnd }) => {
                ...
                filteredAssigned.map((guest) => (
                  <div key={guest.id} className="p-2.5 rounded-lg border border-green-200 dark:border-green-800 bg-green-50/50 dark:bg-green-900/20">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="px-2 py-0.5 text-xs font-medium rounded-full bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 flex-shrink-0">
                        {guest.pax ?? 1} pax
                      </span>
                    </div>
                  </div>
